              ...
              <a href="#">
                ...
                <span class="pull-right-container">
                  <?php if(isset($low_stock_count) && $low_stock_count > 0): ?>
                    <span class="label label-warning pull-right" style="margin-right: 5px;"><?php echo $low_stock_count; ?></span>
                  <?php endif; ?>
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
          ...
          <?php if(in_array('viewReports', $user_permission)): ?>
            ...
            <li id="forecastNav">
              <a href="<?php echo base_url('forecast/') ?>">
                <i class="fa fa-magic text-yellow"></i> <span>AI Demand Forecast</span>
              </a>
            </li>
          <?php endif; ?>
